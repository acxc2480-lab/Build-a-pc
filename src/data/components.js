...
export const componentCategories = [
  { id: 'cpu', name: 'CPU', icon: '🔲', order: 1 },
  { id: 'vga', name: 'VGA (GPU)', icon: '🎮', order: 2 },
  { id: 'mainboard', name: 'Mainboard', icon: '🔧', order: 3 },
  { id: 'ram', name: 'RAM', icon: '💾', order: 4 },
  { id: 'ssd', name: 'SSD', icon: '💿', order: 5 },
  { id: 'hdd', name: 'HDD', icon: '📀', order: 6 },
  { id: 'psu', name: 'PSU', icon: '⚡', order: 7 },
  { id: 'cooling', name: 'Cooling System', icon: '❄️', order: 8 },
  { id: 'case', name: 'Case', icon: '🖥️', order: 9 },
];
